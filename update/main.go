...
func main() {
	...
	const aboutText = `<p>I'm an experienced software engineer specialising in platform security and backend systems, with 7+ years of experience across fintech and developer security tooling. I currently mostly use Go, Python and TypeScript and Postgres for development.</p>`
	...
	data := fmt.Sprintf("%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n\n%s\n%s\n\n%s\n\n%s", title, aboutText, socialLinks, latestPostsTitle, article, note, devArticle, techStackTitle, techStackText, githubStatsTitle, githubStatsText, updated)
